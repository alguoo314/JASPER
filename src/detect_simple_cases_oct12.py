...
def main(db_path,query_path,threshold,k,test,fix,fout,tout,fixedout):
    try:
        #t = Timer()
...
if __name__ == '__main__':
    ...
    main(args.db,args.query,args.threshold,args.ksize,args.test,args.fix,args.fout,args.tout,args.fixedout)
