...
#ifndef __JFLIB_ERR_HPP__
#define __JFLIB_ERR_HPP__
...
namespace err {
  ...
  public:
    ...
    die_t &operator<<(const str &x) {
      no_t::write(std::cerr, x.get_e());
      return *this;
    }
  ...
  public:
    ...
    raise_t & operator<<(const str &x) {
      no_t::write(oss, x.get_e());
      return *this;
    }
    template<typename T>
