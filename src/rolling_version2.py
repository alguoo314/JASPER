        ...
        for seqname,seq in seq_dict.items():
            ...
            while i < len(seq)-k+1: #k is 25 : 
                ...
                if occurrance < threshold:
                    ...
                    print(count_record) #testing purpose
                    ...
                    if len(count_record) > 0:                        
                        while  len(count_record) > 0 and qf[jf.MerDNA(seq[good_before-k+2:good_before+2]).get_canonical()] >= 0.5*sum(count_record)/len(count_record) and good_before < good_after:
                            if good_before == -1:
                                break
