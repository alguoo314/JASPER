...
public:
  ...
  test_cmdline(int argc, char* argv[]) :
    name_arg(), name_given(false)
  { parse(argc, argv); }
  ...
  void parse(int argc, char* argv[]) {
    ...
    static const char *short_options = "hVUn:";
...
#define CHECK_ERR(type,val,which) if(!err.empty()) { ::std::cerr << "Invalid " #type " '" << val << "' for [" which "]: " << err << "\n"; exit(1); }
  ...
  static const char * usage() { return "Usage: test_cmdline [options]"; }
  class error {
    int code_;
  ...
  static const char * help() { return
    ...
    " -n, --name=string                        Say hello to this individual\n"
    " -U, --usage                              Usage\n"
    " -h, --help                               This message\n"
    " -V, --version                            Version";
  }
